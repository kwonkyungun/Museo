...
import com.sparta.museo.MainActivity
import com.sparta.museo.databinding.ActivityLoginBinding
    ...
    fun kakaoSingUp() {
        ...
        binding.kakaoLogin.setOnClickListener {
            val callback: (OAuthToken?, Throwable?) -> Unit = { token, error ->
                if (error != null) {
                    Log.e("com/sparta/museo/Login", "카카오계정으로 로그인 실패", error)
                } else if (token != null) {
                    Log.i("com/sparta/museo/Login", "카카오계정으로 로그인 성공 ${token.accessToken}")
                    startActivity(intent)
                }
            }
            ...
            if (UserApiClient.instance.isKakaoTalkLoginAvailable(this)) {
                UserApiClient.instance.loginWithKakaoTalk(this) { token, error ->
                    if (error != null) {
                        Log.e("com/sparta/museo/Login", "카카오톡으로 로그인 실패", error)
                        ...
                        Log.i("com/sparta/museo/Login", "카카오톡으로 로그인 성공 ${token.accessToken}")
                        startActivity(intent)
                    }
                }
            } else {
